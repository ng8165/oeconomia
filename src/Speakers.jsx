...
import am from "./img/people/angela_ma.jpeg";
import dd from "./img/people/daryn_dodson.jpeg";
import gg from "./img/people/guru_guruganesh.jpeg";
import ks from "./img/people/kelly_steckelberg.jpeg";
import ls from "./img/people/larry_stone.jpeg";
import mj from "./img/people/matthew_jackson.jpeg";
import rl from "./img/people/randall_lewis.png";
import rj from "./img/people/rupa_jack.jpeg";
import rr from "./img/people/russ_roberts.jpeg";
    ...
    return (
        <>
            ...
            <Swiper
                ...
                navigation
                loop={true}
                breakpoints={{ 600: { slidesPerView: 2 }, 1000: { slidesPerView: 3 }, 1800: { slidesPerView: 4 }, 2500: { slidesPerView: 5 }}}
            >
                        ...
                        <SwiperSlide key={index} className="speaker-slide">
                            <Card className="speaker-card">
                                <Card.Body className="speaker-body">
                                    <img className="speaker-img" src={speaker.img} alt={speaker.name} />
                                    <Card.Title><h2 className="mt-2">{speaker.name}</h2></Card.Title>
